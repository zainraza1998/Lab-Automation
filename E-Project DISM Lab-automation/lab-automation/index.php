...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <div class="welcome-msg pt-3 pb-4">
      <h1>Hi <span class="text-primary"><?php echo($name); ?></span></h1>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <?php 
                // foreach($ob->total_pro() as $to){
                //   echo $to['total'];
                // }
                $total = mysqli_fetch_array($ob->total_srs(),MYSQLI_ASSOC)['Total_srs'];
                echo $total;
                 ?>
                </h3>
                <p class="stat-text">SRS</p>
              </div>
            </div>
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                <i class="lnr lnr-eye"> </i>
                <h3 class="text-secondary number"><?php
                // foreach($ob->total_admin() as $admin){
                //   echo($admin);

                // }
                 $total = mysqli_fetch_array($ob->total_admin(),MYSQLI_ASSOC)['Total_Admin'];
                 echo $total;
                ?></h3>
                <p class="stat-text"> Admin</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-6 pr-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
                ...
                <h3 class="text-success number"><?php
                 $total = mysqli_fetch_array($ob->total_cpri(),MYSQLI_ASSOC)['Total_cpri'];
                 echo $total;
                ?></h3>
                <p class="stat-text"> CPRI</p>
              </div>
            </div>
            <div class="col-sm-6 pl-sm-2 statistics-grid">
              <div class="card card_border border-primary-top p-4">
    ...
    <div class="chart">
      <div class="row">
        <div class="col-lg-6 pr-lg-2 chart-grid">
          ...
          <img src="assets/images/dld-lab-1-300x167.png" alt="">
           ...
           <tbody>
 -->
<!-- // foreach($ob->total_pro_qty() as $qty){
//   echo('
//   <tr>
//            <td>'.$qty['c_name'].'</td>
//            <td>'.$qty['COUNT(p.p_cid)'].'</td>
//  </tr>
//   ');

...
<section>
  ...
  <div class="sidebar-menu sticky-sidebar-menu">
    ...
    <!-- logo start -->
    <div class="logo">
      <h1><a href="index.php">LAB AUTO</a></h1>
    </div>  
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list">
          ...
          <ul class="sub-menu-list">
            ...
            <li><a href="view-user-account.php">view</a></li>
          </ul>
        </li>
        <li><a href="pro-list.php"><i class="fa fa-list-alt" aria-hidden="true"></i>
 <span>Product List</span></a></li>
        
        <li class="menu-list">
          <a href="#"><i class="fa fa-list" aria-hidden="true"></i>
            <span>Product Catigory<i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
            
            <li><a href="add-catlog.php">Add-catlog</a> </li>
            <li><a href="catlog-list.php">Catigory List</a></li>
           
          </ul>

        <li class="menu-list">
          <a href="#"><i class="fa fa-product-hunt" aria-hidden="true"></i>
            <span>Products<i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
            
            <li><a href="add-product.php">Add-product</a> </li>
            <!-- <li><a href="product.php">Products List</a></li> -->
            <li><a href="view-product.php">View Products List</a></li>
            <li><a href="trash-product.php">Trash Products</a></li>
            
          </ul>
          <li class="menu-list">
          <a href="#"><i class="fa fa-link" aria-hidden="true"></i>
            <span>Testing<i class="lnr lnr-chevron-right"></i></span></a>
          <ul class="sub-menu-list">
            
            <li><a href="test-catlog.php">Testing Catigory</a> </li>
            <li><a href="Start-testing.php">start Testing</a></li>
            <li><a href="testing-list.php">Testing list</a></li>
           
          </ul>
          <li><a href="market-pro.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
 <span>Market Product</span></a></li>
  ...
  <div class="header sticky-header">
    ...
    <div class="menu-right">
      <div class="navbar user-panel-top">
        <img style="height: 60px;     margin-right: 800px;" src="assets/images/logo 1.png" alt="">
...
<?php
                    foreach($ob->user_data() as $user){
                      echo('<img src="assets/images/user/'.$user['u_img'].'" class="rounded-circle" alt="" />');
                    }
                    ?>  
